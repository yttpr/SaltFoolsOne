...
// Type: THE_DEAD.DryDirectDamagePierceEffect
...
namespace THE_DEAD
{
  public class DryDirectDamagePierceEffect : EffectSO
  {
    [SerializeField]
      ...
      out int exitAmount)
    {
      ...
      foreach (TargetSlotInfo target in targets)
      {
        if (target.HasUnit)
        {
          ...
          DamageInfo damageInfo = target.Unit.Damage(amount2, caster, this._deathType, targetSlotOffset, false, ignoresShield: true);
