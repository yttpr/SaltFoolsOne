...
namespace THE_DEAD
{
  public class Anesthetics_StatusEffect : IStatusEffect, ITriggerEffect<IStatusEffector>
  {
    ...
    public void OnTriggerAttached(IStatusEffector caller)
    {
      ...
      CombatManager.Instance.AddObserver(new Action<object, object>(this.OnTurnStart), TriggerCalls.OnTurnStart.ToString(), (object) caller);
    }
    ...
    public void OnTriggerDettached(IStatusEffector caller)
    {
      ...
      CombatManager.Instance.RemoveObserver(new Action<object, object>(this.OnTurnStart), TriggerCalls.OnTurnStart.ToString(), (object) caller);
    }
