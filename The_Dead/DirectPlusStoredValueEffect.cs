...
// Type: THE_DEAD.DirectPlusStoredValueEffect
...
namespace THE_DEAD
{
  public class DirectPlusStoredValueEffect : EffectSO
  {
    [SerializeField]
      ...
      out int exitAmount)
    {
      ...
      foreach (TargetSlotInfo target in targets)
      {
        if (target.HasUnit)
        {
          ...
          DamageInfo damageInfo = target.Unit.Damage(num + storedValue, (IUnit) null, DeathType.Basic, targetSlotOffset);
