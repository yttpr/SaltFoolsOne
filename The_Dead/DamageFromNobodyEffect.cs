...
// Type: THE_DEAD.DamageFromNobodyEffect
      ...
      out int exitAmount)
    {
      ...
      foreach (TargetSlotInfo target in targets)
      {
        if (target.HasUnit)
        {
          ...
          {
            int amount2 = entryVariable;
            damageInfo = target.Unit.Damage(amount2, (IUnit) null, this._deathType, targetSlotOffset, ignoresShield: this._ignoreShield);
          }
